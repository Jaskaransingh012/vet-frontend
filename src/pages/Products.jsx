      ...
      <main className="p-8">
        <section className="grid gap-12 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 p-4">
          {[{
            ...
            <div key={index} className="border-2 border-gray-300 rounded-xl shadow-lg p-6 hover:border-blue-500 transition-all hover:shadow-2xl hover:scale-105 duration-300">
